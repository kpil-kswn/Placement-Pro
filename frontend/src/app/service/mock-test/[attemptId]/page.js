    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <aside className="w-72 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
        <div className="p-6 border-b border-gray-100 bg-gray-900 text-white flex justify-between items-center">
          ...
          <span
            className={`font-mono text-xl font-bold ${timeLeft.startsWith("0") && timeLeft !== "00:00" && parseInt(timeLeft.split(":")[0]) < 5 ? "text-red-400" : "text-emerald-400"}`}
          >
            {timeLeft}
          </span>
        </div>
            ...
            {currentQuestion.options.map((opt, i) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span
                    className={`text-lg ${isSelected ? "text-indigo-900 font-medium" : "text-gray-700"}`}
                  >
                    {opt}
                  </span>
                </label>
