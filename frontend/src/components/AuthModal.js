...
export default function AuthModal({ isOpen, onClose }) {
  ...
  // We save the entire modal UI into a variable
  const modalContent = (
          ...
          {isLogin && (
            <div className="space-y-5">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-bold py-3.5 px-4 rounded-xl hover:bg-gray-100 hover:-translate-y-0.5 transition-all shadow-sm"
              >
                <img
              ...
              <form onSubmit={handleCredentialsLogin} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  className="w-full mt-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold py-3.5 px-4 rounded-xl transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_25px_rgba(79,70,229,0.5)] hover:-translate-y-0.5"
                >
                  Sign In
                </button>
              </form>
              ...
              {signupStep === 1 ? (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <button
                    ...
                    className="text-xs text-slate-500 hover:text-slate-300 underline text-center w-full mt-5 transition-colors"
                  >
                    (Dev: Skip to Password Step)
                  </button>
                </div>
              ) : (
                <form className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-4">
                  <div className="flex flex-col items-center justify-center mb-6 space-y-2">
                    ...
                    <p className="text-slate-400 text-sm text-center">
                      Secure your account by creating a password for future email logins.
                    </p>
                  </div>
  ...
  // We use createPortal to inject the UI directly into the document body
